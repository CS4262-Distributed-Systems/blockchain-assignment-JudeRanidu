...
public final class AssetTransfer implements ContractInterface {
    ...
    public Asset DuplicateAsset(final Context ctx, final String assetID, final String owner) {
        ...
        Asset oldAsset = genson.deserialize(assetJSON, Asset.class);
        String duplicatedID = assetID + " duplicated";
        Asset duplicatedAsset = new Asset(duplicatedID, oldAsset.getColor(), oldAsset.getSize(), owner, oldAsset.getAppraisedValue());

        //Use Genson to convert the Asset into string, sort it alphabetically and serialize it into a json string
        String sortedJson = genson.serialize(duplicatedAsset);
        stub.putStringState(duplicatedID, sortedJson);
